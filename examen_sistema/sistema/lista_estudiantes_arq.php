...
<head>
    ...
    <title>Lista de cadetes artillería </title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li> <a href="notas_arquitectura.php"><span class="icon-pencil2"></span>NOTAS DE CADETES</a></li>


                <li> <a href="arquitectura.php"><span class="icon-home"></span></span>ATRAS</a></li>
                </div>
    ...
    <div class="contenedor1">
        <h2 class="titulo">LISTA DE ESTUDIANTES ARTILLERÍA</h2>
