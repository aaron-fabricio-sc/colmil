...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <li><a href="lista_estudiantes_conta.php? id='lista_estudiantes_conta'"><span class="icon-pencil2"></span>LISTA DE CADETES</a></li>
                <li class="submenu">
                    <a href="notas_contaduria.php"><span class="icon-folder-open"></span> NOTAS CADETES</a>
