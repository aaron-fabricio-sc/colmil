...
<head>
    ...
    <title>Notas de cadetes artillería </title>
</head>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li> <a href="lista_estudiantes_arq.php"><span class="icon-user"></span>LISTA DE CADETES</a></li>
    ...
    <div class="contenedor1">
        <h2 class="titulo">NOTAS DE CADETES</h2>
