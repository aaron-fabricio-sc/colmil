...
if (!empty($_POST)) {
    $alert = '';
    if (
        empty($_POST['nombre']) || empty($_POST['ap_paterno']) || empty($_POST['ap_materno'])
...
<head>
    ...
    <title>Registro de catedes</title>
</head>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li> <a href="lista_estudiantes_total.php"><span class="icon-file-text2"></span>LISTA DE CADETES</a></li>
    ...
    <div class="contenedor1">
        <h2 class="titulo">REGISTRO DE CADETES</h2>
