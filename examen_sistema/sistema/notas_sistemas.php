...
<head>
    ...
    <title>Notas de cadete caballeria </title>
</head>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li> <a href="lista_estudiantes_sistemas.php"><span class="icon-user"></span>LISTA DE CADETES</a></li>
        ...
        <div class="tablas">
            <table>
                ...
                $query = mysqli_query($conection, "SELECT e.id,e.nombre,e.ap_paterno,e.ap_materno,e.gestion,n.carrera,n.promedio,n.segunda_instancia,n.materia,n.cod_nota
                        FROM estudiantes e INNER JOIN notas n ON e.id = n.estudiante WHERE e.carrera='CAB'");
