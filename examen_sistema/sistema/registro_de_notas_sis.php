...
if (!empty($_POST)) {
    ...
    if (
        empty($_POST['uno']) || empty($_POST['dos'])
    ...
    <div class="contenedor1">
        ...
        <form class="form1 px-1" action="" method="post">
            ...
            <div class="contenedor2">
                ...
                <div><label for="EST" class="label_for1">Curso</label>
                    <?php
                ...
                <div>
                    ...
                    <label for="EST" class="label_for1">Profesor</label>
                    <?php
                ...
                <div>
                    <label for="PARCIAL1" class="label_for1">Proyecto 1:</label>
                    <input type="text" name="uno" id="PARCIAL1" class="input_form1">

                </div>
                <div>
                    <label for="PARCIAL2" class="label_for1">Proyecto 2: </label>
                    <input type="text" name="dos" id="PARCIAL2" class="input_form1">
                </div>
                <div>
                    <label for="PARCIAL3" class="label_for1">Proyecto 3:</label>
