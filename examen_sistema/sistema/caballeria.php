...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <li><a href="lista_estudiantes_sistemas.php"><span class="icon-folder-open"></span>LISTA DE CADETES</a></li>
                <li class="submenu">
                    <a href="notas_sistemas.php"><span class="icon-pencil2"></span> NOTAS CADETES</a>
